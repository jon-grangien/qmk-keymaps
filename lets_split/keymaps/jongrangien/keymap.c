 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Config| Ctrl | Alt  | GUI  |Lower | Bksp |SftSpc|Raise | RCTRL| C_TAB| RALT | Fn   |
 * `-----------------------------------------------------------------------------------'
 */
[_COLEMAK] = LAYOUT_ortho_4x12( \
  ...
  CONFIG,         KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_BSPC,      SHIFT_SPC,  RAISE,   KC_RCTL,  CTRL_TAB, KC_RALT, FN  \
),
