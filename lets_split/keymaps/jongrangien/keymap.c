...
[_LOWER] = LAYOUT_ortho_4x12( \
  ...
  _______,  KC_LGUI,    KC_ASTR, KC_AMPR, KC_RCBR, KC_PLUS, /**/ _______, KC_4,    KC_5,   KC_6,   KC_PLUS, _______, \
  _______,  S(KC_LGUI), KC_GRV,  KC_UNDS, KC_PIPE, _______, /**/ _______, KC_1,    KC_2,   KC_3,   KC_MINS, _______, \
