 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |Config| Ctrl | Alt  | GUI  |Lower |SftBsp|Space |Raise | RCTRL| C_TAB| RALT | Fn   |
 * `-----------------------------------------------------------------------------------'
 */
[_COLEMAK] = LAYOUT_ortho_4x12( \
  ...
  CONFIG,         KC_LCTL, KC_LALT, KC_LGUI, LOWER,   SHIFT_BCKSPC, KC_SPC,  RAISE,   KC_RCTL,  CTRL_TAB, KC_RALT, FN  \
),
...
[_LOWER] = LAYOUT_ortho_4x12( \
  ...
  _______,  _______, KC_LBRC, KC_RBRC, KC_UNDS, KC_PIPE, KC_AMPR, KC_1, KC_2,   KC_3,    KC_HOME, SHFT_ALT_TAB, \
  _______,  _______, _______, _______, _______, _______, _______, KC_0, KC_DOT, _______, KC_END,  KC_PSCR \
),
...
[_RAISE] = LAYOUT_ortho_4x12( \
  _______, _______, _______,    _______,    _______,    _______, KC_ASTR, KC_EQUAL, KC_UNDS, KC_MINS, KC_PLUS, KC_BSLS, \
...
[_CONFIG] =  LAYOUT_ortho_4x12( \
  ...
  _______, KC_MPRV, KC_MNXT,     KC_VOLD, KC_VOLU, KC_MPLY, _______, _______, _______, _______, _______, _______ \
),
};
