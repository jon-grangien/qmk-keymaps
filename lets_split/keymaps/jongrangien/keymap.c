...
[_LOWER] = LAYOUT_ortho_4x12( \
  ...
  _______, KC_CIRC, KC_AMPR, KC_ASTR, KC_TILDE, KC_GRAVE, /**/ KC_PIPE, KC_4,       KC_5,   KC_6,    KC_PLUS, _______, \
  _______, _______, _______, _______, KC_UNDS,  _______,  /**/ _______, KC_1,       KC_2,   KC_3,    KC_MINS, _______, \
...
[_RAISE] = LAYOUT_ortho_4x12( \
  _______, _______, _______,    _______,    _______,    _______, /**/ _______,    _______,  KC_EQUAL,    KC_MINS,      _______,  _______, \
  _______, _______, RALT(KC_Q), RALT(KC_W), RALT(KC_P), _______, /**/ _______,    KC_LEFT,  KC_DOWN,     KC_UP,        KC_RIGHT, _______, \
  _______, KC_LPRN, KC_LBRC,    KC_RBRC,    KC_RPRN,    _______, /**/ CTRL_S_TAB, CTRL_TAB, WIN_WS_LEFT, WIN_WS_RIGHT, _______,  _______,   \
...
[_ADJUST] =  LAYOUT_ortho_4x12( \
  _______, _______, _______, _______,      _______, _______, /**/ _______, _______, _______, _______, _______, _______, \
  _______, _______, GUI_TAB, SHFT_ALT_TAB, ALT_TAB, _______, /**/ _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______,      _______, _______, /**/ _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______,      _______, _______, /**/ _______, _______, _______, _______, _______, _______ \
  ),
